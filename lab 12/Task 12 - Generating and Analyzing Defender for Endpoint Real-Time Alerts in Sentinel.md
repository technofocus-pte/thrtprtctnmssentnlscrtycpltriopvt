...
2.  Navigate to **C:UsersAdmin5802**, copy **RanSim** folder and
    placed in **C:**
...
6.  On the **New User Variable** dialog box, in the **Variable
    name** field, enter +++**TargetPath**+++, and in the **Variable
    value** field, enter +++**C:\RanSim**+++, then press
    the **OK** button.
...
+++**SecurityAlert | where ProviderName == "MDATP" | where AlertSeverity == "Medium"**+++
